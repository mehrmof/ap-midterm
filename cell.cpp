#include "cell.h"
    ...
    // ezafe kardan choromosomes be vector
    void Cell::sett(Genome genome)
    {   
        choromosomes.push_back(genome);
    }
    // cell tashkil mishavad ya sharayetesh ro nadare
    ...
    // az choromosome n s1 va az choromosomes m s2 ro jabeja mikone
    ...
    // check ke palindrome hast ya na 
